          ...
          function () {
            ...
            (t = function () {
                    ...
                    (function () {
                      ...
                      function c() {
                        !(function () {
                          ...
                          for (e = 0; e < n.length; e++)
                            (t = n.eq(e)), l.scrollTrackItems.push(t);
                        })(),
                          n.on('scroll.event-tracker', function () {
                            r &&
                              ...
                              setTimeout(function () {
                                var t = g();
                                h(t),
                                  l.scrollbarTrackingBreakpoints &&
                                    (function (t) {
                                      var i,
                                        n,
                                        o,
                                        ...
                                        s,
                                        a,
                                        c = l.scrollbarTrackingContext.height(),
                                        u = l.scrollbarTrackingBreakpoints,
                                        h = [];
                                      for (var d in u)
                                        (i = u[d][0]),
                                          (o = u[d][1]),
                                          ...
                                          t < (i * c) / 100
                                            ? h.push(u[d])
                                            : (e(['_setCustomVar', o, r, n, s]),
                                              e(['_trackEvent', r, n, a, !0]));
                                      l.scrollbarTrackingBreakpoints = h;
                                    })(t),
                                  (r = !0);
                              }, 150));
                          }),
                      ...
                      function u() {
                        i('body').on(
                          ...
                          '[data-track-links]',
                          function (e) {
                            'A' === e.target.tagName && k(i(e.target));
                          }
                        );
                      }
                      function h(e) {
                        var t,
                          i,
                          n = [];
                        for (i = 0; i < l.scrollTrackItems.length; i++)
                          e > (t = l.scrollTrackItems[i]).offset().top + o
                            ? v(t)
                            : n.push(t);
                        l.scrollTrackItems = n;
                      }
                      function d(e) {
                      ...
                      return {
                        ...
                        removeElementsVisualized: h,
                        enableScrollbarTrackingByBreakpoint: function (e, t) {
                          (l.scrollbarTrackingContext = e),
                            (l.scrollbarTrackingBreakpoints = t);
                        },
                      };
                    })()),
              ...
              window.setTimeout(function e() {
                window.jQuery ? t() : window.setTimeout(e, 20);
              }, 20);
          },
          !1
        );
          ...
          var t,
            ...
            l =
              ...
              null == (n = i.type)
                ? void 0
                : n.value;
          if (null == (o = e.target) || null == (r = o.attributes) || !r.type) {
            var s,
              a,
              c = e.target.closest('amp-social-share');
            c &&
              (l =
                null == (s = c.attributes) || null == (a = s.type)
                  ? void 0
                  : a.value);
          }
          window.trackerBuilder &&
...
!(function (t) {
  ...
  function (t, n, r) {
    ...
    var e = new Map([
      ...
      i = window.cdaaas.SETTINGS.ENV,
      a = window.cdaaas.SETTINGS.CHANNEL,
      u = window.cdaaas.SETTINGS.SITE_ID;
    function c(t, n) {
      return 'prod' === t
        ? (function (t) {
            return o.get(t);
      ...
      return window.libAnalyticsReady
        ...
        : (function (t) {
            if (window.dataLayer) {
              ...
              return void 0 !== n ? n[t] : void 0;
            }
          })(t);
    }
    function f() {
      return {
        dimension21: s('bd_suser_provider'),
        dimension22: s('bd_suser_code'),
        dimension98: s('bd_suser_provider'),
        dimension99: s('bd_suser_code'),
      };
    }
    n.a = function () {
      return {
        ga: { productUA: window.cdaaas.SETTINGS.PRODUCT_UA, extras: f() },
        ga4: {
          user_id: (function () {
            var t = window.Cadun;
            if (t) return t.user.me.globoId;
          })(),
          endpoint_keys: {
            measurementId: c(i, u),
            clientId: (function () {
              ...
              return (t && t.match(/(\d+\.\d\.+)(.*$)/)[2]) || '';
            })(),
          },
          event_params: f(),
          user_properties: {
            consumption_environment: 'web',
            platform: 'desktop' === a ? 'desktop' : 'mobile',
          },
        },
      };
    };
  ...
  function (t, n, r) {
    (function (n, r) {
      t.exports = (function () {
        ...
        function P(t, n) {
          t._state === _ && ((t._state = S), (t._result = n), u(x, t));
        }
        function L(t, n, r, e) {
        ...
        function A(t) {
          ...
          if (0 !== n.length) {
            for (
              var e = void 0, o = void 0, i = t._result, a = 0;
              a < n.length;
              a += 3
            )
              (e = n[a]), (o = n[a + r]), e ? G(r, e, o, i) : o(i);
        ...
        var C = (function () {
            ...
            return (
              (t.prototype._enumerate = function (t) {
                for (var n = 0; this._state === _ && n < t.length; n++)
              ...
              (t.prototype._eachEntry = function (t, n) {
                ...
                if (e === m) {
                  ...
                  if (o === w && t._state !== _)
                    ...
                    var u = new r(g);
                    a ? P(u, i) : E(u, t, o), this._willSettleAt(u, n);
                  } else
                    this._willSettleAt(
                      new r(function (n) {
                        return n(t);
              ...
              (t.prototype._settledAt = function (t, n, r) {
                ...
                e._state === _ &&
                  (this._remaining--,
                  t === S ? P(e, r) : (this._result[n] = r)),
                  0 === this._remaining && T(e, this._result);
              }),
  ...
  function (t, n, r) {
    ...
    (function (t) {
      ...
      function i(n, r, e, o, i, a, u) {
        ...
        c.done ? r(s) : t.resolve(s).then(o, i);
      }
      function a(n) {
        return function () {
          var r = this,
              ...
              return o.a.wrap(function (n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      return (n.next = 2), window.globalWebdeps('cadun');
                    case 2:
                      return (
                        (r = window),
                        (e = r.Cadun),
                        (i = new t(function (t) {
                          e.Event.subscribe('userInfoAvailable', function () {
                            var n =
                              0 < arguments.length && void 0 !== arguments[0]
                                ? arguments[0]
                                : {};
                            return t({
                              glb_id: n.globoId ? n.globoId : null,
                              glb_tipo: n.globoId ? 'logado' : 'anonimo',
                            });
                          });
                        })),
                        n.abrupt('return', i)
              ...
              return o.a.wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 2:
                      return (
                        (n = t.sent), t.abrupt('return', n.glb_id || void 0)
                      );
                    case 4:
                    case 'end':
                      return t.stop();
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (t.next = 2), u();
                    case 2:
                      return (n = t.sent), t.abrupt('return', n.glb_tipo);
                    case 4:
                    case 'end':
                      return t.stop();
                  }
                  ...
                  switch ((t.prev = t.next)) {
                    ...
                    case 9:
                      (f = t.sent),
                        ...
                        (h = l.join('&') || void 0),
                        (p = new URLSearchParams(h) || void 0),
                        (u.ASYNC_OPTIONS = s(
                          {
                            adCustomData: h,
                            daiCustomData: Object.fromEntries(p),
                          },
                          Object(a.a)()
                        )),
                        n(u.ASYNC_OPTIONS);
            ...
            o.a.mark(function t() {
              ...
              return o.a.wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      (n = window.cdaaas.SETTINGS.PLAYER).OPTIONS = s(
                        {},
                        n.OPTIONS,
                        {},
                        Object(a.a)()
            ...
            return o.a.wrap(function (n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  ...
                  case 2:
                    (r = window.cdaaas.SETTINGS.PLAYER),
                      (e = {}),
                      (i = []),
                      r.OPTIONS.adCustomData && i.push(r.OPTIONS.adCustomData),
                      ...
                      (f = function (t) {
                        try {
                          ...
                          if (n) {
                            var r = function (t, n) {
                                return String(n)
                                  ? ''.concat(t, '=').concat(String(n))
                                  : '';
                              },
                              e =
                                'object' !== u(n) || Array.isArray(n)
                                  ? r(t, n)
                                  : ((o = n),
                                    Object.keys(o)
                                      .map(function (t) {
                      ...
                      (r.OPTIONS = s({}, r.OPTIONS, {}, e, {}, Object(a.a)(), {
                        adCustomData: l,
                        daiCustomData: Object.fromEntries(h),
                      })),
                      (v = new t(p)),
                      (r.getAsyncData = function () {
                        return v;
                      });
                  case 17:
                  case 'end':
  ...
  function (t, n) {
    ...
    (o.nextTick = function (t) {
      ...
      s.push(new p(t, n)), 1 !== s.length || f || u(d);
    }),
            ...
            (i._invoke = (function (t, n, r) {
              ...
              return function (o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  var c = f(t, n, r);
                  if ('normal' === c.type) {
                    if (((e = r.done ? p : h), c.arg === v)) continue;
                    return { value: c.arg, done: r.done };
                  }
                  'throw' === c.type &&
                    ((e = p), (r.method = 'throw'), (r.arg = c.arg));
                }
              };
            })(t, r, a)),
            i
        ...
        Object(u.a)(function (n) {
          n.configure(
            (function (t) {
              ...
              return t;
            })({ adPublisherProvidedID: t }, Object(s.a)())
          );
        });
      }
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        if ((e = Object(f.a)())) return (t.next = 5), w(e);
                        t.next = 7;
                        break;
                      case 5:
                        0 < (o = t.sent).length && v(o);
                      case 7:
                      case 'end':
                        return t.stop();
                    }
      ...
      n.a = function (n) {
        return i()(function () {
          ...
          return n &&
            n.Player &&
            n.PlayerManager &&
            n.PlayerManager.length !== e
            ? ((e = n.PlayerManager.length), { done: !0, value: n })
            : null;
        }).then(function (t) {
          return t.PlayerManager.forEach(n);
        });
      };
    }).call(this, r(5));
  },
  function (t, n, r) {
    ...
    (function (n) {
      t.exports = function (t, r) {
        var e = 1 < arguments.length && void 0 !== r ? r : {},
          o = e.initialInterval,
          i = void 0 === o ? 100 : o,
          a = e.attemptsBeforeSlowing,
          u = void 0 === a ? 20 : a,
          c = e.timeout,
          s = void 0 === c ? 6e4 : c,
          f = Date.now(),
          ...
          : new n(function (n, r) {
              d = (function e(o) {
                return setInterval(function () {
                  ...
                  return p && p.done
                    ? (clearInterval(d), void n(p.value))
                    : (function (t, n) {
                        return t + n < Date.now();
                      })(f, s)
                    ? (clearInterval(d),
                    ...
                    : u < l
                    ? ((l = 0), (h *= 2), clearInterval(d), void (d = e(h)))
                    : void (l += 1);
                }, o);
              })(h);
            });
...
!(function (e) {
  var t = new Error('invalid response'),
    n = {
      apiUrl: 'https://rec.ads.globo.com/get_recommendations',
      cacheKey: 'recadsLastRecommendation',
      alternativeKey: 'rec_alt',
      testIdKey: 'rec_testid',
      adsDivId: 'banner_materia2',
      abEnv: 'prod-https',
      abExperiment: 'REC-ADS-MC-LAZY-LOADING-POC',
      abFallbackAlternative: 'fallback',
      abControlAlternative: 'controle',
    };
  function a(...t) {
    e.location.search.includes('REC_DEBUG') && console.log('[RECADS]', ...t);
  }
  function r(t, n, a) {
    e.googletag.cmd.push(function () {
      e.googletag.pubads().addEventListener(t, e => {
        e.slot.getSlotElementId() === n && a(e.slot);
      });
    });
  }
  function o() {
    var t = {};
    try {
      var r = e.localStorage.getItem(n.cacheKey),
        o = JSON.parse(r);
      for (var i in o)
        o.hasOwnProperty(i) && i.startsWith('rec_') && (t[i] = o[i]);
    } catch (e) {
      a('FAILURE: to parse tags', e);
    }
    return t;
  }
  e.globalWebdeps('cadun', 'globo-ab-sdk').then(function () {
    Cadun.Event.subscribe('userInfoAvailable', function (i) {
      (e.googletag = e.googletag || { cmd: [] }),
        (function (i) {
          var s = new GloboAbSdk();
          a('AB Version:', s.getVersion());
          var l = s.ab(n.abEnv);
          l.addHeader({
            'x-canonical-uri': e.location.href.split('?')[0].split('#')[0],
          });
          var c = l.createExperiment(n.abExperiment);
          l.choose([c], i)
            .then(function (r) {
              return (
                r.experiments[0].alternative != n.abControlAlternative
                  ? fetch(n.apiUrl, {
                      method: 'POST',
                      cache: 'no-cache',
                      body: JSON.stringify({
                        userid: i,
                        algorithm: r.experiments[0].alternative,
                      }),
                      ...
                      .then(function (a) {
                        if (
                          ...
                          throw t;
                        e.localStorage.setItem(n.cacheKey, a);
                      })
                      .catch(function (e) {
                        a('FAILURE: to fetch recommendations, reason:', e);
                      })
                  : e.localStorage.removeItem(n.cacheKey),
                new Promise(e => e(r))
              );
            })
            .then(function (e) {
              !(function (e, t, i, s, l) {
                ...
                a(
                  ...
                  r('slotAdded', c, function (e) {
                    var t = o();
                    for (var r in t)
                      if (t.hasOwnProperty(r)) {
                        var l = t[r];
                        e.setTargeting(r, String(l)),
                          a('set adSlot: ', c, 'setTargetting:', r, '=', l);
                      }
                    var d =
                      i != n.abControlAlternative && 0 == Object.keys(t).length
                        ? n.abFallbackAlternative
                        : i;
                    e.setTargeting(n.alternativeKey, String(d)),
                      a(
                        'set adSlot: ',
                        c,
                        'setTargetting:',
                      ...
                      e.setTargeting(n.testIdKey, String(s)),
                      a(
                        'set adSlot: ',
                        c,
                        'setTargetting:',
                  ...
                  r('impressionViewable', c, function () {
                    var r = o(),
                      c =
                        i != n.abControlAlternative &&
                        0 == Object.keys(r).length
                          ? n.abFallbackAlternative
                          : i;
                    e.impression(
                      { experiment: t, alternative: c, testId: s },
                      l
                    ),
                      a(
                        'impression',
                ...
                l,
                e.experiments[0].name,
                e.experiments[0].alternative,
                e.experiments[0].testId,
                i
              );
            });
        })(i.globoId || i.id);
...
(() => {
  ...
  var e =
    ...
    n = t.SITE_ID,
    r = {
      g1: 'https://recomendacao.globo.com/rec/v2/item/g1/next-article',
      ge: 'https://recomendacao.globo.com/rec/v2/item/ge/next-article',
      'dev-beta': 'https://recomendacao.globo.com/rec/v2/item/g1/next-article',
    }[n],
    a = {
    ...
    i = document.getElementsByClassName('next-article')[0],
    s = i
      ? i.getElementsByClassName('next-article__wrapper-header-title')[0]
      : null,
    c = i
      ? i.getElementsByClassName('next-article__wrapper-header-icon')[0]
      : null,
    l = i ? i.getElementsByClassName('next-article-desktop-link')[0] : null,
    u = i ? i.getElementsByClassName('next-article-smart-link')[0] : null,
    d = i ? i.getElementsByClassName('next-article-image-desktop')[0] : null,
    m = i ? i.getElementsByClassName('next-article-image')[0] : null,
    g =
      (i &&
        i.getElementsByClassName(
          'next-article__wrapper-header-button-close'
        )[0],
      i ? document.getElementsByClassName('next-article-sticky')[0] : null),
    v = document.getElementById('header-produto'),
    h =
      ('local' === e ||
        'qa' === e ||
        t.IS_PREVIEW ||
  ...
  function E() {
    return (E = x(function* () {
      var e = yield fetch(r + '?url=' + window.location.href, o)
        .then(e => e.json())
        .catch(e =>
          w.error("[Show] - [Next-Article] - [requestData] - [Error]': " + e)
        );
  ...
  function C() {
    return (
      (C = x(function* () {
        ...
        e
          ? ((s.innerText = 'Sugerida para você'),
            (c.style.backgroundImage =
              "url('https://s3.glbimg.com/v1/AUTH_378ee63fe83141e69caddd838034e850/static/noticia/icons/icon-star.svg')"),
            (l.innerText = e.content.title),
            l.setAttribute('href', e.content.url),
            (u.innerText = e.content.title),
            u.setAttribute('href', e.content.url),
            (d.src = e.content.image ? e.content.image.sizes.XS.url : a),
            d.setAttribute('alt', e.content.title),
            (m.src = e.content.image ? e.content.image.sizes.XS.url : a),
            d.setAttribute('alt', e.content.title),
      ...
      _(),
        ...
        new MutationObserver(() => {
          var e = document.querySelector('#next-article'),
            ...
            n = v.classList.contains('sticky') && t,
            r = v.classList.contains('header-personalized');
          N(),
            r && (e.style.transition = 'top 300ms linear'),
            (e.style.top = n ? '53px' : '0px');
        }).observe(v, { attributes: !0, attributeFilter: ['class'] }),
        ...
        new IntersectionObserver(
          ...
          { rootMargin: -S + 'px 0px 0px 0px', threshold: [0, 1] }
  ...
  (k = document.querySelector(h)) &&
    new IntersectionObserver(
      (e, t) => {
        ...
        e.forEach(e => {
          var r = e.target;
          e.isIntersecting && (n || B(), (n = !0), t.unobserve(r));
        });
      },
  ...
  (n.n = e => {
    ...
    (() => {
      ...
      class U {
        ...
        getVideoById(e) {
          return this.videos.find(t => t.content.video.id === parseInt(e, 10));
        }
...
(() => {
  ...
  var f = n => n.filter(n => !n.content.url.includes(window.location.pathname));
  function h() {
    return (h = m(function* () {
