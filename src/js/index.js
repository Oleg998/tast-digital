                        ...
                        value: function () {
                          ...
                          (this.state = h),
                            ...
                            setTimeout(function () {
                              ...
                              .default.SCHEMA_LOAD_COLLECTION_RETRY_AFTER_MSECS);
                        },
                      },
                      {
                        key: 'onLoad',
  ...
  (() => {
    ...
    const u = {
      qa: {
        env: 'qa',
        auth_server_url:
          'https://id.qa.globoi.com/auth/realms/globo.com/protocol/openid-connect/auth',
        client_globoid_url:
          'https://s3.glbimg.com/v1/AUTH_05f06ca986b54d6e9c5df94927ccf7fc/libs/globoid-js/1.3.1/globoid-js.min.js',
        oidcProvider: 'https://id.qa.globoi.com/auth/realms/globo.com',
      ...
      prod: {
        env: 'prod',
        auth_server_url:
          'https://id.globo.com/auth/realms/globo.com/protocol/openid-connect/auth',
        client_globoid_url:
          'https://s3.glbimg.com/v1/AUTH_05f06ca986b54d6e9c5df94927ccf7fc/libs/globoid-js/1.3.1/globoid-js.min.js',
    ...
    class g {
      constructor(e) {
        (this.props = e),
          ...
          (this.onScrollLeft = e => {
            this.state.scroll.hasMovedLeft ||
              (S.getInstance().send('barra globo', 'Swipe', 'left'),
          ...
          (this.onScrollRight = e => {
            this.state.scroll.hasMovedRight ||
              (S.getInstance().send('barra globo', 'Swipe', 'right'),
        ...
        (this.props = e),
          (this.handleClick = e => {
            S.getInstance().send(
              ...
              R.getInstance().event('barra globo', this.props.url, !1, 'click');
          });
      }
      createElement() {
    ...
    class m {
      ...
      overrideDefaultProducts(e) {
        return v.defaultProducts.map(t => {
    ...
    class I {
      constructor(e) {
        (this.props = e),
          ...
          (this.dropdownLogin = new E({ root: this.props.root, onLogout: i }));
      }
      createElement() {
    ...
    class E {
        ...
        (this.props = e),
          ...
          (this.handleClickLogout = e => {
            this.props.root.shadowRoot
              ...
              this.close(),
              S.getInstance().send('barra globo', 'Click Usuário', 'Sair'),
      ...
      open() {
        this.isOpen() ||
          (this.props.root.shadowRoot
            .querySelector('.container-dropdown-login')
            .classList.add('open'),
          S.getInstance().send('barra globo', 'Click Usuário', 'Abrir'),
          R.getInstance().event(
            'barra globo',
            'Click Usuário - Abrir',
            !0,
      ...
      close() {
        this.props.root.shadowRoot
          ...
          S.getInstance().send('barra globo', 'Click Usuário', 'Fechar'),
          R.getInstance().event(
            'barra globo',
      ...
      createTemplate() {
        return (
          ...
          (o = function* () {
            ...
            this.barraConfig = Object.assign({}, v);
            try {
    ...
    class S {
      ...
      initHorizon() {
        const t = new e();
        this._horizon = new C.HorizonClient(
          t.get('SITE_ID'),
          t.get('MOBILE_GROUP'),
          'barra-globo'
        );
    ...
    class k extends HTMLElement {
        ...
        return (
          ...
          (o = function* () {
            ...
            if (
              ...
              const t = new m(this.tenantId, this.productsConfig),
                n = new _(t, this);
      ...
      onLoaded(e) {
        this.hideOverlayAddictionalProducts(),
          S.getInstance().send('barra globo', 'View', null),
          e.incluirComScore && O(),
    ...
    customElements.define('nova-barra-globocom', k);
  })();
})();
